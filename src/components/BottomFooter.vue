...
.page-footer {
    ...
    grid-gap: 20px;
    grid-template-areas:
      'img-container list-documentation list-contributing list-community'
      'bottom-footer-container bottom-footer-container bottom-footer-container bottom-footer-container';
    color: #ffffff;
    font-weight: 300;
